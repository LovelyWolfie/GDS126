...
for(let i=0; i<100; i++)
{
	bullets[i] = new GameObject({width:115, height:128})
	//bullets[i].img.src="images/mrt.jpg"
	bullets[i].img.src=`images/float.png`
	bullets[i].makeSprite(playerData)
	bullets[i].y=-10000
	bullets[i].changeState(`eye`)
}
